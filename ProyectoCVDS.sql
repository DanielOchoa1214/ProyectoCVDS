...
CREATE TABLE LIBRO (
    ...
    `pages` INT NOT NULL,
    PRIMARY KEY (`id`),
    CONSTRAINT `FK_LIBRO_RECURSO_1` FOREIGN KEY (`id`) REFERENCES RECURSO(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB;
...
CREATE TABLE PORTATIL (
    ...
    PRIMARY KEY (`id`),
    CONSTRAINT `FK_PORTATIL_RECURSO_1` FOREIGN KEY (`id`) REFERENCES RECURSO(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB;
...
CREATE PROCEDURE before_insert_libro(
    ...
    pages int)
        BEGIN
            ...
            INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES (id, author, hard_cover, pages);
        end $$
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('AJF-267', 'Tu madre', true, 300);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('AJF-268', 'Tu madre', true, 300);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('AJF-269', 'Tu madre', false, 300);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('DGR-738', 'Tu padre', true, 500);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('DGR-634', 'Tu padre', true, 500);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('ALS-956', 'Tu hermano', true, 1000);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('ALS-957', 'Tu hermano', true, 1000);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('ALS-958', 'Tu hermano', false, 1000);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('ALS-959', 'Tu hermano', true, 1000);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('HGL-230', 'Jorge Martinez', true, 3000);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('HGL-231', 'Jorge Martinez', true, 3000);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('HGL-232', 'Jorge Martinez', false, 3000);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('HGL-233', 'Jorge Martinez', false, 3000);
...
INSERT INTO LIBRO (id, author, hard_cover, pages) VALUES ('HGL-234', 'Jorge Martinez', false, 3000);
